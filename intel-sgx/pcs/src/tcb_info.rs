...
impl<'de, T: PlatformTypeWithTcbDeserializer<T>> Deserialize<'de> for TcbData<T, Unverified> {
...
impl PlatformTypeWithTcbDeserializer<platform::SGX> for platform::SGX {
...
#[allow(dead_code)]
#[allow(unused)]
impl PlatformTypeWithTcbDeserializer<platform::TDX> for platform::TDX  {
...
impl<'de, T: PlatformTypeWithTcbDeserializer<T>> TcbData<T, Unverified> {
...
impl<V: VerificationType, T: PlatformType> TcbData<T, V> {
    ...
    pub(crate) fn decompose_raw_cpusvn(&self, raw_cpusvn: &[u8; 16], pce_svn: u16) -> Result<TcbComponents, Error> {
        ...
        Ok(TcbComponents::from_raw(*raw_cpusvn, pce_svn, None))
    }
...
pub struct TcbInfo<T: PlatformTypeWithTcbDeserializer<T>> {
    raw_tcb_info: String,
    signature: Vec<u8>,
    ca_chain: Vec<String>,
    #[serde(skip)]
...
impl<T: PlatformTypeWithTcbDeserializer<T>> TcbInfo<T> {
